...
Los resumenes han cambiado totalmente.
...
Es la imagen27.jpg. El mensaje es "Al Fascismo no se le discute, se le destruye." Buenaventura Durruti". Automatizaria la busqueda usando en cada carpeta el comando: "sha256sum *.jpg | grep "hash_imagen"
